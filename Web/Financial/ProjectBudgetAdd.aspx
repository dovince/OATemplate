<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectBudgetAdd.aspx.cs" Inherits="Financial_ProjectBudgetAdd" %>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null && !data.Code) {
                            ...
                            var lbl = $("#lbl" + costname);
                            if (lbl.length > 0) {
                                lbl.text("当前预算比例:" + data.Message);
                            }
                        }
                    }
                });
        ...
        <div>
            ...
            <table class="tb_normal" style="width: 100%">
                ...
                <tr>
                    ...
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txtComment" runat="server" Width="300px" TextMode="MultiLine" Height="40px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="TitleStyle" colspan="4">
                ...
                <tr>
                    ...
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt工资及津贴" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl工资及津贴" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl工资及津贴" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    <td class="auto-style115">2.工程出包费：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt工程出包费" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl工程出包费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl工程出包费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style114">3.材料费：</td>
                    <td class="auto-style110" style="background-color: #ffffff" colspan="">
                        <asp:TextBox ID="txt材料费" runat="server" CssClass="BudgetControl" Width="150px" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl材料费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl材料费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    <td class="auto-style114">4.租赁费：</td>
                    <td class="auto-style110" style="background-color: #ffffff">
                        <asp:TextBox ID="txt租赁费" runat="server" CssClass="BudgetControl" Width="150px" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl租赁费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl租赁费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style115">5.劳务费：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt劳务费" runat="server" CssClass="BudgetControl" Width="150px" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl劳务费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl劳务费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    <td class="auto-style114">6.安全生产费用:</td>
                    <td class="auto-style110" style="background-color: #ffffff">
                        <asp:TextBox ID="txt安全生产费用" runat="server" CssClass="BudgetControl" Width="150px" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl安全生产费用" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl安全生产费用" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style115">7.办公费：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt办公费" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl办公费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl办公费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    <td class="auto-style115">8.维修费用：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt维修费用" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元</strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl维修费用" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl维修费用" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style115">9.交通运输费用：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txt交通运输费用" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl交通运输费用" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl交通运输费用" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    <td class="auto-style114">10.差旅费：</td>
                    <td class="auto-style110" style="background-color: #ffffff">
                        <asp:TextBox ID="txt差旅费" runat="server" Width="150px" CssClass="BudgetControl" Style="text-align: right; ime-mode: disabled;" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;" ToolTip=""></asp:TextBox>
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl差旅费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl差旅费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style110" style="background-color: #ffffff">
                        ...
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl邮电费用" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl邮电费用" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    ...
                    <td class="auto-style110" style="background-color: #ffffff">
                        ...
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl水电费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl水电费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style110" style="background-color: #ffffff">
                        ...
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl会议费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl会议费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                    ...
                    <td class="auto-style110" style="background-color: #ffffff">
                        ...
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl印刷费" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl印刷费" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style110" style="background-color: #ffffff" colspan="3">
                        ...
                        &nbsp;<strong>元 </strong>&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbl其它费用" runat="server" Text="当前预算比例:{0}"></asp:Label>&nbsp; &nbsp;&nbsp;
                                <asp:Label ID="ctl其它费用" runat="server" Text="预算控制比例:{0}"></asp:Label>
                    </td>
                </tr>
