<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectCostModify.aspx.cs" Inherits="Financial_ProjectCostModify" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="tb_normal" style="width: 100%">
                <tr>
                    <td valign="middle" style="border-bottom: #006633 1px; height: 30px;">&nbsp;<img src="../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;&gt;&gt;&nbsp;财务管理&nbsp;&gt;&gt; 项目成本核算信息修改</td>
            ...
            <table class="tb_normal" style="width: 100%">
                ...
                <tr>
                    <td class="MainStyle">项目编号<a style="color: #FF0000; font-size: 18px;">*</a>：</td>
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txtXMID" runat="server" Width="320px" AutoPostBack="True" ToolTip="如果找不到项目编号，请先在项目管理中登记项目基本信息" Wrap="False" ReadOnly="True"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style5" style="background-color: #ffffff">
                        <asp:TextBox ID="txtHTJE" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;"
                            onpaste="return false;" Style="ime-mode: disabled;" runat="server" Width="320px"></asp:TextBox>&nbsp;元
                    </td>
                    <td class="MainStyle">结算金额：</td>
                    <td class="style24" style="background-color: #ffffff">
                        <asp:TextBox ID="txtJSJE" onkeypress="if((event.keyCode<48||event.keyCode>57)&&event.keyCode!=45&&event.keyCode!=46)event.returnValue=false;"
                            onpaste="return false;" runat="server" Width="250px"></asp:TextBox>
                        &nbsp;元</td>
                    <td class="MainStyle">应付金额：</td>
                    <td class="style24" style="background-color: #ffffff">
                        <asp:TextBox ID="txtCBZCHJ" runat="server" Width="200px"></asp:TextBox>
                        &nbsp;元</td>
                </tr>
                <tr>
                    <td class="MainStyle">项目金额：</td>
                    <td class="style24" colspan="5" style="background-color: #ffffff">
                        <asp:TextBox ID="txtXMJE" runat="server" Width="244px"></asp:TextBox>
                        &nbsp;元</td>
                </tr>
            </table>
        </div>
