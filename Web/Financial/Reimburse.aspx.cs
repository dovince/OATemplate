...
public partial class Financial_Reimburse : System.Web.UI.Page
{
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from ERPReimburse where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPReimburse where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
