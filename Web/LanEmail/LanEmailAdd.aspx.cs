...
public partial class LanEmail_LanEmailAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        MyModel.EmailContent = TxtContent.Text;
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "新邮件发送成功！", "LanEmailShou.aspx");
    }
    ...
    protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "添加到草稿箱成功！", "LanEmailShou.aspx");
    }
}