        ...
        <div>
            <table class="tb_normal" style="width: 100%">
                <tr>
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px ; height: 30px;">查询：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="100px"></asp:TextBox><asp:ImageButton
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                            CssClass="tb_normal" OnRowDataBound="GVData_RowDataBound" PageSize="15" Width="100%">
