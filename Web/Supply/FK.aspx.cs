...
public partial class Supply_FK : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        var T = context.ERPRecive.Where(p => p.ID > 0 && p.NowState == "F");
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from ERPRecive where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select HeTongName,QianYueKeHu,HTJE,TiXingDate,DaoKuanDate,CreateUser,CreateTime,NowState from ERPRecive where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
