...
public partial class RequireCreate_ERPBaoCanManager : System.Web.UI.Page
{
    ...
    public void DataBindToGridview(string nworkid)
    {
        ...
        ds = MyModel.GetListNotInManager(sql, "ERPBaoCan", "BCRQ asc,ID desc");
    ...
    protected void GVData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (commandName == "quxiao")
        {
            ...
            var result = ZWL.DBUtility.DbHelperSQL.ExecuteSQL("UPDATE [ERPBaoCan] SET [IsCancel] = '是',[CancelTime] = '" + DateTime.Now + "' WHERE ID='" + id + "' and (([ShiJianDian] = '午餐' and [BCRQ] > '" + DateTime.Now.AddHours(-9).ToString("yyyy-MM-dd") + "') or ([ShiJianDian] = '早餐' and [BCRQ] > '" + DateTime.Now.ToString("yyyy-MM-dd") + "'))");
        }
        DataBindToGridview("");
        return;
    }
