...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERPBaoCanAddManager.aspx.cs" Inherits="RequireCreate_ERPBaoCanAddManager" %>
        ...
        <div>
            <table style="width: 100%; border: 0;" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="border-bottom: #006633 1px dashed; height: 30px; text-align: right; vertical-align: middle;">
                        ...
                        <%--<asp:Button Text="批量报餐" style="color:blue; padding:5px 10px !important;border:1px solid #000000;height:auto;" ID="Button_PiLiBaoCan" runat="server" ImageAlign="AbsMiddle" OnClientClick="return window.confirm('您确认报餐吗？')" />
                        <asp:Button Text="批量取消" style="color:red; padding:5px 10px !important;border:1px solid #000000;height:auto;" ID="Button_PiLiQuXiao" runat="server" ImageAlign="AbsMiddle" OnClientClick="return window.confirm('您确认取消该报餐吗？')" />--%>
                        <%--<asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/images/Button/ResultSerch.jpg" OnClick="ImageButton6_Click" Visible="False" Style="height: 19px" />--%>&nbsp; &nbsp;
            ...
            <table style="border-width: 1px; border-style: groove; width: 100%; border-collapse: collapse; border-bottom: #444444 1px solid;" border="1" rules="all" cellpadding="3" cellspacing="0">
                <tr>
                    ...
                    <td align="left" valign="middle" style="width: 80%;" class="auto-style1">
                    ...
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <asp:Button Text="报餐" style="color:blue; padding:5px 10px !important;border:1px solid #000000;height:auto;" Visible='<%# CanBaoCan(DataBinder.Eval(Container.DataItem, "ID")) %>' ID="Button_BaoCan" runat="server" ImageAlign="AbsMiddle" OnClientClick="return window.confirm('您确认报餐吗？')" CommandName="baocan" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID")%>' />
                                    <asp:Button Text="取消报餐" style="color:red; padding:5px 10px !important;border:1px solid #000000;height:auto;" Visible='<%# CanCancel(DataBinder.Eval(Container.DataItem, "ID")) %>' ID="ImageButton7" runat="server" ImageAlign="AbsMiddle" OnClientClick="return window.confirm('您确认取消该报餐吗？')" CommandName="quxiao" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID")%>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="报餐日期">
                                <ItemTemplate>
                                    <%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "BCRQ")).ToString("yyyy-MM-dd") %>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="报餐情况">
                                <ItemTemplate>
                                    <%# GetBaoCanQingKuang(Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "BCRQ")), DataBinder.Eval(Container.DataItem, "UserName").ToString()) %>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="餐单">
                                <ItemTemplate>
                                    <a style='<%# GetCaiDanTuPian(Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "BCRQ"))) == "" ? "display:none;" : "" %>' href="<%# "../UploadFile/" + GetCaiDanTuPian(Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "BCRQ"))) %>" target="_blank">当周菜单<span style="color:red;">[点击打开]</span></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
