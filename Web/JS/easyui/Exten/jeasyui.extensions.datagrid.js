...
(function () {
    ...
    function initRowContextMenu(t, opts) {
        if (opts.enableRowContextMenu) {
            opts.onRowContextMenuBak = opts.onRowContextMenu;
            opts.onRowContextMenu = function (e, rowIndex, rowData) {
                if ($.isFunction(opts.onRowContextMenuBak)) { opts.onRowContextMenuBak.apply(this, arguments); }
                var eventData = $.fn.datagrid.extensions.parseContextMenuEventData(t, opts, e),
                    items = parseRowContextMenuItems(t, opts, rowIndex, rowData, eventData,e);
        ...
        if (opts.rowTooltip) {
            ...
            tr.children("td[field]").each(function () {
                ...
                if (!$.data(td[0], "tooltip")) {
                    ...
                    html = content
                    if (content) {
                        if (!copts.isCustomTooltip)
                            content = "<div class='tooltip-div'>" + content + "</div>";
    ...
    function parseRowContextMenuItems(t, opts, rowIndex, rowData, eventData,e) {
        ...
        var baseItems = parseRowBaseContextMenuItems(t, opts, rowIndex, rowData, eventData);
    ...
    function parseRowBaseContextMenuItems(t, opts, rowIndex,rowData, eventData) {
