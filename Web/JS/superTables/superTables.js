...
var superTable = function (tableId, options) {
    ...
    if (this.fixedCols > 0) {
        ...
        this.sFHeaderWidth = this.sDataTable.tBodies[0].rows[cleanRow].cells[this.fixedCols] ? this.sDataTable.tBodies[0].rows[cleanRow].cells[this.fixedCols].offsetLeft : 0;
