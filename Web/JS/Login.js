...
function ValidateCode() {
    ...
    var url = "/ValidateCode.aspx?Code=" + document.getElementById("TxtCode").value;
...
function SetMd5Password() {
    var uPwd = $("#TxtUserPwd").val();
    $("#hdfUserPwd").val(hex_md5(uPwd).toUpperCase());
    $("#TxtUserPwd").val("");
