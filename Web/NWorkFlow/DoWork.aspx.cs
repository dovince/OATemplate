...
public partial class NWorkFlow_DoWork : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.HyperLink1.NavigateUrl = "../NWorkFlow/NWorkFlowMap.aspx?ID=" + ZWL.Common.PublicMethod.EncryptParam(MyModel.ID);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            string PiShiStr = "<font color=#0000FF>" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "&nbsp;&nbsp;" + DateTime.Now.ToString() + "&nbsp;&nbsp;</font><BR><div class=\"showShenPiYiJianFormat\">" + this.TextBox1.Text.ToString() + "</div><br>审批附件：<a href=../UploadFile/" + FileNameStr + ">[右键下载]</a><hr>" + this.Label5.Text;
        ...
        {
            string PiShiStr = "<font color=#0000FF>" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "&nbsp;&nbsp;" + DateTime.Now.ToString() + "&nbsp;&nbsp;</font><BR><div class=\"showShenPiYiJianFormat\">" + this.TextBox1.Text.ToString() + "</div><hr>" + this.Label5.Text;
            ZWL.DBUtility.DbHelperSQL.ExecuteSQL("update ERPNWorkToDo set FuJianList='" + ZWL.Common.PublicMethod.GetSessionValue("WenJianList") + "',OKUserList=OKUserList+'," + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "',ShenPiYiJian='" + PiShiStr + "' where ID=" + Request.QueryString["ID"].ToString());
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else if (FileUpload1.PostedFile.FileName.Trim().Length <= 0)
        {
            ...
            MyMail.TimeStr = DateTime.Now;
            MyMail.ToUser = Mymodel.UserName;
            //增加驳回工作提醒查看信息内容（sj--2014.11.24）
            MyMail.FormID = int.Parse(Mymodel.FormID.ToString());
            MyMail.WorkFlowID = int.Parse(Mymodel.WorkFlowID.ToString());
            MyMail.BeiYong1 = Mymodel.BeiYong1;
    ...
    {
        Response.Redirect("PrintWork.aspx?ID=" + ZWL.Common.PublicMethod.EncryptParam(Request.QueryString["ID"].ToString()));
    }
