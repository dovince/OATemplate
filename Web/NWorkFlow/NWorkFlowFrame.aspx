<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NWorkFlowFrame.aspx.cs" Inherits="NWorkFlow_NWorkFlowFrame" %>
    ...
    <form id="form1" runat="server">
		...
		<div class="lui_profile_moduleIndex_down" data-frame="downFrame">
			...
			<div class="lui_profile_moduleIndex_tree" data-frame="treeFrame">
				<iframe name="treeFrame" class="lui_profile_moduleIndex_treeframe" src="NFormList.aspx" frameborder="no" border="0"></iframe>
			</div>
			<!-- ctrlFrame1 -->
			...
			<div class="lui_profile_moduleIndex_org" data-frame="orgFrame" style="width: 0px;">
				<iframe name="orgFrame" class="lui_profile_moduleIndex_orgFrame" src="NFormList.aspx" frameborder="no" border="0"></iframe>
			</div>
			<!-- ctrlFrame2 -->
			...
			<div class="lui_profile_moduleIndex_right" data-frame="rightFrame" style="left: 200px;">
				...
				<div class="lui_profile_moduleIndex_view">
					<iframe name="viewFrame" class="lui_profile_moduleIndex_viewframe" src="NWorkFlow.aspx?FormID=0" frameborder="no" border="0"></iframe>
				</div>
