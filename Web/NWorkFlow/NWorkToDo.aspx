                ...
                <tr>
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px ; height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                        ...
                        src="../images/Button/search.gif" /><asp:ImageButton ID="ImageButton4" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
                            OnClick="ImageButton4_Click" /><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ResultSerch.jpg" OnClick="ImageButton6_Click" Visible="false" />&nbsp; &nbsp;<asp:ImageButton ID="ImageButton3" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnDel.jpg"
