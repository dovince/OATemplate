...
public partial class NWorkFlow_NWorkFlowNodeModify : System.Web.UI.Page
{
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "节点定义信息修改成功！", "NWorkFlowNode.aspx?FormID=" + Request.QueryString["ID"] + "&WorkFlowID=" + Request.QueryString["WorkFLowID"].ToString());
	}
}
