...
<body onload="javascript:document.getElementById('TextBox5').readOnly=true;Load_Do();">
    ...
    <div>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr>
                <td style="width: 170px; height: 25px; background-color: #f6f6f6" align="right">
                    工作名称：
                </td>
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtWorkName" runat="server" Width="350px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtWorkName"
