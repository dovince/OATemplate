    ...
    <form id="form1" runat="server">
        ...
        <table class="tb_normal" style="width: 100%"> 
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <HeaderStyle HorizontalAlign="Center" Font-Size="12px" Height="30px" /><AlternatingRowStyle BackColor="WhiteSmoke" />
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
					...
					<asp:TemplateField HeaderText="工作名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "../NWorkFlow/NWorkToDoViewNew.aspx?ID="+ ZWL.Common.PublicMethod.EncryptParam(DataBinder.Eval(Container.DataItem, "ID"))%>'><%# DataBinder.Eval(Container.DataItem, "WorkName")%></asp:HyperLink>&nbsp;
                        <asp:HyperLink ID="HyperLink21" runat="server" Font-Underline="True" ToolTip='<%# DataBinder.Eval(Container.DataItem, "ShenPiUserList")%>' NavigateUrl='<%# "../NWorkFlow/DoWorkNew.aspx?DoType=putong&ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' Font-Bold="true" ForeColor="Red">[继续办理]</asp:HyperLink></ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
