        ...
        <div>
            <table class="tb_normal" style="width: 100%">
                <tr>
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px ; height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                    ...
                    </asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="250px"></asp:TextBox><img class="HerCss"
                    ...
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="工作名称">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "../NWorkFlow/NWorkToDoViewNew.aspx?ID="+ ZWL.Common.PublicMethod.EncryptParam(DataBinder.Eval(Container.DataItem, "ID"))%>'><%# DataBinder.Eval(Container.DataItem, "WorkName")%></asp:HyperLink>&nbsp;
                        <asp:HyperLink ID="HyperLink21" runat="server" Font-Underline="True" ToolTip='<%# DataBinder.Eval(Container.DataItem, "ShenPiUserList")%>' NavigateUrl='<%# "../NWorkFlow/DoWorkNew.aspx?DoType=putong&ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' Font-Bold="true" ForeColor="Red">[继续办理]</asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>


                            <asp:BoundField DataField="UserName" HeaderText="发起人" ItemStyle-Width="60px"></asp:BoundField>
                            <asp:BoundField DataField="TimeStr" HeaderText="发起时间"></asp:BoundField>
                            <asp:TemplateField HeaderText="节点名称">
                                <ItemTemplate>
                                    <%# ZWL.DBUtility.DbHelperSQL.GetSHSL("select top 1 WorkFlowName from ERPNWorkFlow where ID=" + DataBinder.Eval(Container.DataItem, "WorkFlowID").ToString())%>--
                                    [<asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="True" Target="_blank"
                                        NavigateUrl='<%# "../NWorkFlow/NWorkFlowMap.aspx?WorkFlowID="+DataBinder.Eval(Container.DataItem, "WorkFlowID") %>'
                                        ForeColor="Blue" ToolTip="点击查看流程图示"><%# DataBinder.Eval(Container.DataItem, "JieDianName")%></asp:HyperLink>]
                                </ItemTemplate>
