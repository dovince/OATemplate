            ...
            <tr>
                <td>
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="True" NavigateUrl='<%# "../NWorkFlow/DoWorkNew.aspx?DoType=qiangzhi&ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' Font-Bold="true" ForeColor="Red">[强制办理]</asp:HyperLink>
                                </ItemTemplate>
