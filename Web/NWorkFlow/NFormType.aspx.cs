...
public partial class NWorkFlow_NFormType : System.Web.UI.Page
{
	...
	protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
	{
		...
		if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from ERPNFormType where ID in (" + IDlist + ")") == -1)
		{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select  TypeName,PaiXuStr,BackInfo  from ERPNFormType where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}
