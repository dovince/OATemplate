    ...
    <form id="form1" runat="server">
        <div>
            ...
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px ; height: 30px;">
					...
					OnClick="ImageButton4_Click" /><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ResultSerch.jpg" OnClick="ImageButton6_Click" Visible="false" />&nbsp; &nbsp;&nbsp;
        ...
        <table class="tb_normal" style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="工作名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "../NWorkFlow/NWorkToDoViewNew.aspx?ID="+ ZWL.Common.PublicMethod.EncryptParam(DataBinder.Eval(Container.DataItem, "ID"))%>'><%# DataBinder.Eval(Container.DataItem, "WorkName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
