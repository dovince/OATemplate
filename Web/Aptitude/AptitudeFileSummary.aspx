<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AptitudeFileSummary.aspx.cs" Inherits="Aptitude_AptitudeFileSummary" %>
        ...
        <div>
            <table class="tb_normal" style="width: 100%">
                <tr>
                    <td valign="middle" style="border-bottom: #006633 1px; height: 30px;">&nbsp;<img src="../images/BanKuaiJianTou.gif" />
                        资质证照管理&nbsp;&gt;&gt;&nbsp;资质使用统计&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="../images/Button/BtnRefresh.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton12_Click" Style="height: 19px" />
            ...
            <table class="tb_normal" style="width: 100%">
                <tr class="querytr">
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px; background-color: #f6f6f6" class="auto-style3"><strong>资质单位:</strong>
                    </td>
                    <td align="left" valign="middle" style="border-bottom: #006633 1px;" class="auto-style3">
                        <asp:TextBox ID="txtAptDept" runat="server" Width="200px"></asp:TextBox>
                    </td>
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px; background-color: #f6f6f6" class="auto-style4"><strong>当前使用人:</strong>
                    </td>
                    <td align="left" valign="middle" style="border-bottom: #006633 1px;" class="auto-style3">
        ...
        <table class="tb_normal" style="width: 100%">
                    ...
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AptitudeName" HeaderText="资质名称">
                                <ItemStyle ForeColor="#0066FF" HorizontalAlign="Left" Width="35%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="AptDepartment" HeaderText="资质单位">
                                <ItemStyle ForeColor="#0066FF" HorizontalAlign="Left" Width="15%" />
                                </asp:BoundField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="LabAptType" runat="server"></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="Times" HeaderText="使用次数"></asp:BoundField>
                            <asp:BoundField DataField="User" HeaderText="当前借用人"></asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>
            ...
            <tr>
                <td style="text-align:center;">
                    ...
                    <asp:TextBox ID="TxtPageSize" runat="server" CssClass="TextBoxCssUnder2" Height="20px" Width="35px">50</asp:TextBox>
                    行每页 &nbsp; 转到第<asp:TextBox ID="GoPage" runat="server" CssClass="TextBoxCssUnder2" Height="20px" Width="33px"></asp:TextBox>
                    页&nbsp;
