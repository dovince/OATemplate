<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AptitudeManage.aspx.cs" Inherits="Aptitude_AptitudeManage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="border-bottom: #006633 1px ; height: 30px;">&nbsp;<img src="../images/BanKuaiJianTou.gif" />
                        资质证照管理&nbsp;&gt;&gt;&nbsp;资质管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="../images/Button/BtnRefresh.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton12_Click" Style="height: 19px" />
            ...
            <table style="width: 100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#99BCFC">
                <tr class="querytr">
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px; background-color: #f6f6f6" class="auto-style3"><strong>是否启用:</strong>
                    </td>
                    <td align="left" valign="middle" style="border-bottom: #006633 1px; " class="auto-style3">
        ...
        <table class="table" cellpadding="0px" cellspacing="0px" style="margin-top: 10px" width="100%">
            <tr>
                <td>
                    <asp:GridView ID="GVData" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Department" HeaderText="资质单位"></asp:BoundField>
                            <asp:TemplateField HeaderText="是否启用">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblIsActive" Font-Bold="true"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
