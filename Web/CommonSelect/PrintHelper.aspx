<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintHelper.aspx.cs" Inherits="CommonSelect_PrintHelper" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function printPdf(url) {
            ...
            printiframe.src = url + "?_=" + Math.random();
        }
        function CCC() {
            window.returnValue = "";
                ...
                <tbody>
                    <tr>
                        <td colspan="2" style="text-align: center; height: 40px;">
                            ...
                            <strong style="font-size: 16px;">
                                <strong>
                                    <a href="javascript:void(0)" class="fa fa-reply" onclick="javascript:CCC();">返回</a>
                                </strong>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <div>
                                <iframe id="previewcontent" scrolling='true' width='100%' height='100%' frameborder='0' src='<%="{0}/UploadFile/DocumentPreview/{1}.html".FormatWith(BaseUrl, Get("filename")) %>'></iframe>
                            </div>
                        </td>
                    </tr>
                </tbody>
