<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfficeSupplyItemImport.aspx.cs" Inherits="CommonSelect_OfficeSupplyItemImport" %>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 5px;">
                            <asp:HyperLink ID="TemplateExcelFilePath" runat="server" Target="_blank"
                                ...
                                NavigateUrl="../ReportFile/办公用品规格型号导入模板.xlsx">
                                办公用品规格型号导入模板.xlsx
                            </asp:HyperLink>
                        </td>
                    </tr>
