<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfficeSupplyInventoryImport.aspx.cs" Inherits="CommonSelect_OfficeSupplyInventoryImport" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding-left: 5px;">
                            <asp:HyperLink ID="TemplateExcelFilePath" runat="server" Target="_blank"
                                Style="text-decoration: underline; color: #51b6ec;"
                                NavigateUrl="../ReportFile/办公用品入库模板.xlsx">
                                办公用品入库模板.xlsx
                            </asp:HyperLink>
                        </td>
                    </tr>
