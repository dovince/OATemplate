<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShouWenShare.aspx.cs" Inherits="CommonSelect_ShouWenShare" %>
    ...
    <form id="form1" runat="server">
        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="lui_form_subject">
                                                        <asp:Label ID="lblFormTitle" runat="server" Text="收文转发"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
            ...
            <table class="tb_normal process_review_panel" width="100%">
                <tbody>
                    <tr>
                        <td class="td_normal_title" style="width: 15%;">标题：</td>
                    ...
                    <tr>                        
                        ...
                        <td colspan="2" style="text-align: left; height: 40px; padding-left: 5px;">
                            <div class="inputselectsgl" style="width: 95%;">
                                <div class="input">
                                    <asp:TextBox ID="ReceivedUser" runat="server" onKeyDown="javascript:return false;" CssClass="inputsgl" onclick="showUserPopwindow('ReceivedUser')"></asp:TextBox>
                                </div>
                            </div>
                            <div class="inputselectsgl">
                                <div onclick="showUserPopwindow('ReceivedUser')" class="orgelement"></div>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ReceivedUser"
