...
namespace ZWL.BLL
{
    ...
    /// </summary>
    [Serializable]
    public partial class ERPHeTongVersion : IBaseModel
    {
        public ERPHeTongVersion()
        { }
        #region Model
        private int _id;
        private int _formid;
        ...
        /// 得到一个对象实体
        /// </summary>
        public ERPHeTongVersion(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM [ERPHeTongVersion] ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [ERPHeTongVersion]");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ERPHeTongVersion] (");
            strSql.Append("WorkName,HTID,HTName,XMID,XMName,HTLB,ZYLB,HYLB,JYFS,JFDW,JFFZR,YFDW,YFFZR,HZDW1,HZFZR1,HZDW2,HZFZR2,HTJE,JJFS,QDTime,KSTime,JZTime,JFLY,QDFS,JEJH1,RQJH1,BZJH1,JEJH2,RQJH2,BZJH2,JEJH3,RQJH3,BZJH3,JEJH4,RQJH4,BZJH4,JEJH5,RQJH5,BZJH5,CJBM,HTZT,XMCJR,JBR,HTGD,GDTime,FormID,HTJYState,XMZT,HTZYNR,NWorkToDoID,BFDW,BFFZR,HTTYPE,ZBTZS,HGZS,Adress,ParentID,RecordID,HTLX,HTXS)");
            ...
            parameters[50].Value = BFDW;
            parameters[51].Value = BFFZR;
            parameters[52].Value = HTTYPE;
            parameters[53].Value = ZBTZS;
            parameters[54].Value = HGZS;
            parameters[55].Value = Adress;
            parameters[56].Value = ParentID;
            parameters[57].Value = RecordID;
            parameters[58].Value = HTLX;
            parameters[59].Value = HTXS;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ERPHeTongVersion] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ERPHeTongVersion] ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public void SetPropertyValue(DataSet ds)
        {
