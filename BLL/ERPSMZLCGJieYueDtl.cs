...
{
	/// <summary>
	/// 类ERPSMZLCGJieYueDtl,涉密资料（成果）借阅子表
	/// </summary>
	public class ERPSMZLCGJieYueDtl
	{
		public ERPSMZLCGJieYueDtl()
		{}
		#region Model
		private int _id;//主键
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [ERPSMZLCGJieYueDtl]");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ERPSMZLCGJieYueDtl] (");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ERPSMZLCGJieYueDtl] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ERPSMZLCGJieYueDtl] ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
