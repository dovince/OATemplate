	...
	public class ERPNWorkFlowNode
	{
		...
		public int Add()
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@JieShuHours", SqlDbType.Int,6),
        ...
        /// 得到一个对象实体
        /// </summary>
        public void GetModel(string sqlWhere)
        {
        ...
        public List<ZWL.BLL.ERPNWorkFlowNode> GetListModel(string strWhere)
        {
            var result = new List<ZWL.BLL.ERPNWorkFlowNode>();
            var ds = GetList(strWhere);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                var re = DataTableHelper.ConvertTo<ZWL.BLL.ERPNWorkFlowNode>(ds.Tables[0]);
                return re;
            }
            return result;
        }
