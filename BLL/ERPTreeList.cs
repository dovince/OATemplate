    ...
    public class ERPTreeList
    {
        ...
        public int Add()
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@PaiXuStr", SqlDbType.Int,6)};
        ...
        public List<ZWL.BLL.ERPTreeList> GetListModel(string strWhere)
        {
            var list = new List<ZWL.BLL.ERPTreeList>();
            var ds = GetList(strWhere);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                list = DataTableHelper.ConvertTo<ZWL.BLL.ERPTreeList>(ds.Tables[0]);
            }
            return list;
        }
        #endregion  成员方法
