...
namespace ZWL.BLL
{
    ...
    /// </summary>
    [Serializable]
    public class YuErLeaveChangeLog
    {
        public YuErLeaveChangeLog()
        { }
		#region Model
		private int _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public YuErLeaveChangeLog(int ID)
		{
			...
			strSql.Append(" FROM [YuErLeaveChangeLog] ");
		...
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("select count(1) from [YuErLeaveChangeLog]");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into [YuErLeaveChangeLog] (");
		...
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("update [YuErLeaveChangeLog] set ");
		...
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("delete from [YuErLeaveChangeLog] ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;
		...
		public YuErLeaveChangeLog(YuErLeave al)
        {
        ...
        public void LogChange(YuErLeave YuErLeave, string changeType, double nxj, string bz = "")
        {
            this.NowWorkAgeAfter = YuErLeave.NowWorkAge;
            this.NowDaysAfter = YuErLeave.NowDays;
            this.NowUsedDaysAfter = YuErLeave.NowUsedDays;
            this.NowRemainDaysAfter = YuErLeave.NowRemainDays;
            this.LastRemainDaysAfter = YuErLeave.LastRemainDays;
            this.LastUsedDaysAfter = YuErLeave.LastUsedDays;
            this.FreezonDayAfter = YuErLeave.FreezonDay;
            this.LastFreezonDayAfter = YuErLeave.LastFreezonDay;
            this.FuJianListAfter = YuErLeave.FuJianList;
            this.ZYHLJDaysAfter = YuErLeave.ZYHLJDays;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"select * FROM YuErLeaveChangeLog");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
