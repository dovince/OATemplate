...
{
    /// <summary>
    /// 类ERPOfficeSupplyStockOut。
    /// </summary>
    [Serializable]
    public partial class ERPOfficeSupplyStockOut
    {
        public ERPOfficeSupplyStockOut()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public ERPOfficeSupplyStockOut(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Comment,NWorkID,CreatorTime,CreatorUser,LastModifyTime,LastModifyUser,DeleteTime,DeleteUser,DeleteMark ");
            strSql.Append(" FROM [ERPOfficeSupplyStockOut] ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [ERPOfficeSupplyStockOut]");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ERPOfficeSupplyStockOut] (");
            strSql.Append("Name,Comment,NWorkID,CreatorTime,CreatorUser,LastModifyTime,LastModifyUser,DeleteTime,DeleteUser,DeleteMark)");
            ...
            parameters[3].Value = CreatorTime;
            parameters[4].Value = CreatorUser;
            parameters[5].Value = LastModifyTime;
            parameters[6].Value = LastModifyUser;
            parameters[7].Value = DeleteTime;
            parameters[8].Value = DeleteUser;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ERPOfficeSupplyStockOut] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ERPOfficeSupplyStockOut] ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
