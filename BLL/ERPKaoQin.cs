...
namespace ZWL.BLL
{
    ...
    public class ERPKaoQin
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string strname,string strdatetime)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from ERPKaoQin");
            strSql.Append(" where UserName='" + strname + "' and DATEDIFF(SECOND,[KaoQinRiQi],'" + strdatetime + "')=0");
        ...
        public int Add()
        {
            ...
            strSql.Append("UserName,GuiDingTime1,DengJiTime1,GuiDingTime2,DengJiTime2,GuiDingTime3,DengJiTime3,GuiDingTime4,DengJiTime4,GuiDingTime5,DengJiTime5,GuiDingTime6,DengJiTime6,KaoQinRiQi,Department)");
            ...
            parameters[14].Value = Department;
        ...
        public void Update()
        {
            ...
            parameters[15].Value = Department;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,UserName,GuiDingTime1,DengJiTime1,GuiDingTime2,DengJiTime2,GuiDingTime3,DengJiTime3,GuiDingTime4,DengJiTime4,GuiDingTime5,DengJiTime5,GuiDingTime6,DengJiTime6,KaoQinRiQi,Department ");
        ...
        public Pager GetListAndPaging(string strWhere, int currPage, int pageSize)
        {
            ...
            return new Pager(strSql.ToString(), currPage, pageSize, "[KaoQinRiQi] desc");
        }
