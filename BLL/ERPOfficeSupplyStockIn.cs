...
{
    /// <summary>
    /// 类ERPOfficeSupplyStockIn。
    /// </summary>
    [Serializable]
    public partial class ERPOfficeSupplyStockIn
    {
        public ERPOfficeSupplyStockIn()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public ERPOfficeSupplyStockIn(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Comment,CreatorTime,CreatorUser,LastModifyTime,LastModifyUser,DeleteTime,DeleteUser,DeleteMark ");
            strSql.Append(" FROM [ERPOfficeSupplyStockIn] ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [ERPOfficeSupplyStockIn]");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ERPOfficeSupplyStockIn] (");
            strSql.Append("Name,Comment,CreatorTime,CreatorUser,LastModifyTime,LastModifyUser,DeleteTime,DeleteUser,DeleteMark)");
            ...
            parameters[2].Value = CreatorTime;
            parameters[3].Value = CreatorUser;
            parameters[4].Value = LastModifyTime;
            parameters[5].Value = LastModifyUser;
            parameters[6].Value = DeleteTime;
            parameters[7].Value = DeleteUser;
            parameters[8].Value = DeleteMark;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ERPOfficeSupplyStockIn] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ERPOfficeSupplyStockIn] ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
