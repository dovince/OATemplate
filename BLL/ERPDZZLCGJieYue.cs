...
{
	/// <summary>
	/// 类ERPDZZLCGJieYue,地质资料（成果）借阅
	/// </summary>
	public class ERPDZZLCGJieYue
	{
		public ERPDZZLCGJieYue()
		{}
		#region Model
		private int _id;//主键
        ...
        /// 得到一个对象实体
        /// </summary>
        public ERPDZZLCGJieYue(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,NWorkToDoID,WorkName,DengJiTime,XiangMuBianHao,XiangMuMingCheng,ZongShuLiang,JieYongShiJianKaiShi,JieYongShiJianJieShu,JieYongQiXian,JieYueFangShi,ShenQingBuMen,ShenQingRen ");
            strSql.Append(" FROM [ERPDZZLCGJieYue] ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [ERPDZZLCGJieYue]");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ERPDZZLCGJieYue] (");
            strSql.Append("NWorkToDoID,WorkName,DengJiTime,XiangMuBianHao,XiangMuMingCheng,ZongShuLiang,JieYongShiJianKaiShi,JieYongShiJianJieShu,JieYongQiXian,JieYueFangShi,ShenQingBuMen,ShenQingRen)");
            ...
            parameters[10].Value = ShenQingBuMen;
       
            parameters[11].Value = ShenQingRen;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ERPDZZLCGJieYue] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ERPDZZLCGJieYue] ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
